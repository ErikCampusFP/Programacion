...
public class Principal {
	...
	public static void llamada1() throws FileNotFoundException {
		llamada2();
	}
	
	public static void llamada2() throws FileNotFoundException {
		llamada3();
	}
	
	public static void llamada3() throws FileNotFoundException {
