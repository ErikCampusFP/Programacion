...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Bebida b1 = new Bebida(100, "Agua mineral");
		Bebida b2 = new Bebida(120, "Coca-Cola");
		Bebida b3 = new Bebida(120, "Aquarius Naranja");
		Bebida b4 = new Bebida(120, "Aquarius Limón");
		Bebida b5 = new Bebida(125, "Fanta Naranja");
		Bebida b6 = new Bebida(125, "Fanta Limón");
		...
		System.out.println("2. Coca-Cola - 1.20 €");
		System.out.println("3. Aquarius Naranja - 1.20 €");
		System.out.println("4. Aquarius Limón - 1.20 €");
		System.out.println("5. Fanta Naranja - 1.25 €");
		System.out.println("6. Fanta Limón - 1.25 €");
